...
mod tests {
    ...
    const TER_1: EbnfElement = EbnfElement::Terminal(Terminal('1'));

    const VAR_A: EbnfElement = EbnfElement::Variable(Variable('A'));
    const VAR_B: EbnfElement = EbnfElement::Variable(Variable('B'));
    const VAR_C: EbnfElement = EbnfElement::Variable(Variable('C'));
